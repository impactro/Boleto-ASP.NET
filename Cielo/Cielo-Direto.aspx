<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cielo-Direto.aspx.cs" Inherits="Cielo_Direto" ValidateRequest="false" %>
...
<body>
    ...
    <div>
        ...
        Numero do Cartão: <asp:TextBox ID="txtCartao" runat="server" Text="4012001037141112"/><br/>
        Validade: <asp:TextBox ID="txtValidade" runat="server" Text="201501"/><br/>
        Cod.Segurança: <asp:TextBox ID="txtCodSeg" runat="server" Text="123"/><br/>
