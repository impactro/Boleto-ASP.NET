...
Partial Class BoletoNet_Suporte1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Cedente.Endereco = "<br />Estrada Elias Alves da Costa, nº 957 <br />BAIRRO: São João <br />CIDADE: Itapevi  <br />UF: SP"
        Cedente.CNPJ = "23047156000123"
        Cedente.Banco = "104-0"
        Cedente.Agencia = "4353"
        Cedente.Conta = "9399"
        Cedente.Carteira = "RG"          ' Código da Carteira
        Cedente.Convenio = "00360305435348"         ' CNPJ do PV da conta do cliente
        Cedente.CodCedente = "435300000658857"   ' Código do Cliente(cedente)
